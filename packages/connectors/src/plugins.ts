...
export const ALL_PLUGINS: Plugin[] = [
  ...
  },
  {
    ...
    name: 'WhatsApp',
    description:
      'Send and receive WhatsApp messages via WhatsApp Business Cloud API. Read conversation history and respond as the agent.',
    category: 'communication',
    connectionType: 'api_key',
    fields: [
      {
  ...
  },
  {
    id: 'google_gemini',
    name: 'Google Gemini',
    description: 'Use Gemini 2.5 Pro, Flash, and other Google models via the Gemini API.',
    category: 'ai',
    connectionType: 'api_key',
    fields: [
      {
      ...
      },
      {
        ...
        type: 'select',
        required: false,
        options: ['gemini-2.5-pro', 'gemini-2.5-flash', 'gemini-2.0-flash', 'gemini-1.5-pro'],
      },
    ],
  ...
  },
  {
    ...
    description:
      'Moonshot AI Kimi models — K2.5, K2, and K2 Thinking. OpenAI-compatible API with strong agentic and long-context capabilities.',
    category: 'ai',
    connectionType: 'api_key',
    fields: [
      {
  ...
  },
  {
    id: 'deepseek',
    name: 'DeepSeek',
    description: 'DeepSeek V3 and R1 reasoning models. OpenAI-compatible API with context caching.',
    category: 'ai',
    connectionType: 'api_key',
    fields: [
      {
  ...
  },
  {
    id: 'xai_grok',
    name: 'xAI Grok',
    description: 'Grok models from xAI. Supports Grok 4 and Grok 3 with real-time web access.',
    category: 'ai',
    connectionType: 'api_key',
    fields: [
      {
      ...
      },
      {
        ...
        type: 'select',
        required: false,
        options: ['grok-4', 'grok-3', 'grok-3-mini', 'grok-3-fast'],
      },
    ],
  ...
  },
  {
    id: 'mistral',
    name: 'Mistral AI',
    description: 'Mistral Large, Small, and Codestral models for coding and general tasks.',
    category: 'ai',
    connectionType: 'api_key',
    fields: [
      {
  ...
  },
  {
    id: 'groq',
    name: 'Groq',
    description: 'Ultra-fast inference for Llama, Mixtral, and Gemma models on Groq LPU hardware.',
    category: 'ai',
    connectionType: 'api_key',
    fields: [
      {
  ...
  },
  {
    ...
    name: 'Together AI',
    description:
      'Run 200+ open-source models including Llama, Kimi K2.5, Qwen, and more via Together AI cloud.',
    category: 'ai',
    connectionType: 'api_key',
    fields: [
      {
  ...
  },
  {
    ...
    name: 'OpenRouter',
    description:
      'Single API key for 300+ models: GPT, Claude, Gemini, Llama, Kimi, Grok, and more. Best for model switching.',
    category: 'ai',
    connectionType: 'api_key',
    fields: [
      {
  ...
  },
  {
    ...
    name: 'Perplexity',
    description:
      'Sonar models with built-in real-time web search for research and up-to-date answers.',
    category: 'ai',
    connectionType: 'api_key',
    fields: [
      {
      ...
      },
      {
        ...
        type: 'select',
        required: false,
        options: ['sonar-pro', 'sonar', 'sonar-reasoning-pro', 'sonar-reasoning'],
      },
    ],
  ...
  },
  {
    ...
    name: 'Cohere',
    description:
      'Command R+ and Command A models optimised for RAG, tool use, and enterprise workloads.',
    category: 'ai',
    connectionType: 'api_key',
    fields: [
      {
      ...
      },
      {
        ...
        type: 'select',
        required: false,
        options: ['command-a-03-2025', 'command-r-plus', 'command-r', 'command-nightly'],
      },
    ],
  ...
  },
  {
    ...
    name: 'Cerebras',
    description:
      'Fastest inference available — Llama 3.3 70B at 2000+ tokens/sec on Cerebras wafer-scale chips.',
    category: 'ai',
    connectionType: 'api_key',
    fields: [
      {
        ...
        type: 'password',
        required: true,
        helpUrl: 'https://cloud.cerebras.ai/platform/api-keys',
      },
      {
        key: 'model',
        label: 'Model',
  ...
  },
  {
    ...
    name: 'Azure OpenAI',
    description:
      'OpenAI models (GPT-4o, o1, o3) hosted on Azure with enterprise SLAs and VNet support.',
    category: 'ai',
    connectionType: 'credentials',
    fields: [
      { key: 'api_key', label: 'API Key', type: 'password', required: true },
  ...
  },
  {
    id: 'amazon_bedrock',
    name: 'Amazon Bedrock',
    description: 'Claude, Llama, Mistral, and other models via AWS Bedrock with IAM-based auth.',
    category: 'ai',
    connectionType: 'credentials',
    fields: [
      ...
      },
      {
        ...
        type: 'text',
        required: false,
        placeholder: 'anthropic.claude-sonnet-4-6-20251001-v1:0',
      },
    ],
